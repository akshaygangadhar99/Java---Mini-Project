...
public class GenerateDatabase {
    ...
    public static void createTable(){
        ...
        String createBuilding = "CREATE TABLE IF NOT EXISTS tblBuilding (bld_id varchar(10)," +
                "street_id varchar(10), bld_name varchar(100), uni_distance float," +
                "three_sharing_avail int, four_sharing_avail int,availability int," +
            ...
            for(int i=0; i<9; i++) {
                ...
                for (int j = 1; j <= 2; j++) {
                    ...
                    String insertBuilding = "INSERT INTO tblBuilding " +
                            "(bld_id, street_id, bld_name, uni_distance, three_sharing_avail, four_sharing_avail, availability) VALUES (" +
